...
AIGW_FILES=(
	...
	"${CUR_DIR}/proxy010-llm-as-judge/aigw-route-judge-kng.yaml"
	"${CUR_DIR}/proxy011-advanced/aigw-route-advanced-kng.yaml"
	...
	"${CUR_DIR}/proxy010-llm-as-judge/aigw-plugin-ai-proxy-advanced-judge-kng.yaml"
	"${CUR_DIR}/proxy010-llm-as-judge/aigw-plugin-ai-llm-as-judge-kng.yaml"
	"${CUR_DIR}/proxy011-advanced/aigw-plugin-ai-proxy-advanced-kng.yaml"
