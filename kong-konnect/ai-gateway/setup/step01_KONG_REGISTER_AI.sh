...
AIGW_FILES=(
	...
	"${CUR_DIR}/proxy007-advanced/aigw-route-advanced-kng.yaml"
	"${CUR_DIR}/proxy008-mcp-proxy/aigw-route-mcp-kng.yaml"
	# --- Plugins ---
	...
	"${CUR_DIR}/proxy005-semantic-cache/aigw-plugin-ai-proxy-semcache-kng.yaml"
	"${CUR_DIR}/proxy005-semantic-cache/aigw-plugin-ai-semantic-cache-kng.yaml"
	"${CUR_DIR}/proxy006-prompt-decorator/aigw-plugin-ai-proxy-decorator-kng.yaml"
	"${CUR_DIR}/proxy006-prompt-decorator/aigw-plugin-ai-prompt-decorator-kng.yaml"
	"${CUR_DIR}/proxy007-advanced/aigw-plugin-ai-proxy-advanced-kng.yaml"
	"${CUR_DIR}/proxy008-mcp-proxy/aigw-plugin-ai-mcp-proxy-kng.yaml"
)
