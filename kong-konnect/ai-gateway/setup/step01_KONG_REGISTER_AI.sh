...
AIGW_FILES=(
	...
	"${CUR_DIR}/proxy004-prompt-decorator/aigw-route-decorator-kng.yaml"
	...
	"${CUR_DIR}/proxy004-prompt-decorator/aigw-plugin-ai-proxy-decorator-kng.yaml"
	"${CUR_DIR}/proxy004-prompt-decorator/aigw-plugin-ai-prompt-decorator-kng.yaml"
